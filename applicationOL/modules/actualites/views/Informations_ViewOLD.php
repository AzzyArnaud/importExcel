...
<div class='modal fade' id='srcs' tabindex="-1">
  ...
  background-size:10px 10px;}">
          <span id="msg"></span>
         <form id="myform" action="<?= base_url('actualites/Informations/add') ?>" method="POST" enctype="multipart/form-data">
...
<!-- SUPPRESSION -->
  ...
  background-size:10px 10px;}">
      ...
      <div class='modal-footer'>
                                                                            <a class='btn btn-danger btn-md' href='<?= base_url()?>actualites/Informations/delete/<?=$value->ID?>'>Supprimer</a>
...
<div class='modal fade' id='modification<?=$value->ID?>' tabindex="-1">
  ...
  background-size:10px 10px;}">
          <span id="msg"></span>
         <form id="myform" action="<?= base_url('actualites/Informations/update/') ?><?=$value->ID?>" method="POST" enctype="multipart/form-data">
...
?>
    ...
    <div class="col-md-8" style="text-align: left;"></div><div class="col-md-4" style="text-align: left;">
         <form id="myform" action="<?= base_url('actualites/Informations/recherche_info') ?>" method="POST" enctype="multipart/form-data">
          ...
          <div class="input-group-append">
            <button class="input-group-text" id="basic-addon2"><span class="lnr lnr-magnifier"></span></button>
                            ...
                            foreach ($info as $value) {
                             $views=$this->Model->getRequeteOne("SELECT count('*') as n FROM actualites_info_view WHERE ID_ACTUALITE=".$value->ID);
                              $date=new DateTime($value->DATE);
                            ?>
                            <div class="row blog_item admin" style=" margin-top: 20px">
                                <!-- <div class="col-lg-12"> -->
                        ...
                        <?php } }else echo "<div class='col-md-12' style=' background:  #EBF0EF; min-height: 150px;text-align:left'><h1 style='color:red'>Aucune information publiée</h1></div>";

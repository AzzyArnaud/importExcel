...
?>
    ...
    <div class="col-md-8" style="text-align: left;"></div><div class="col-md-4" style="text-align: left;">
         <form id="myform" action="<?= base_url('actualites/Informations/recherche_actualite') ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-9">
                                    <div class="blog_post">
                                        ...
                                        <div class="blog_details">
                                            <a href="single-blog.html"><h2><?=$value->TITRE?></h2></a>

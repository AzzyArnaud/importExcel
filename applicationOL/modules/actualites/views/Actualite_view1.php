...
}else echo "<div class='col-md-12' style=' background:  #EBF0EF; min-height: 150px;text-align:left'><h1 style='color:red'>Il n'ya aucune Réponse</h1></div>";
?> 
</div>
<?php
...
$('.admin').mouseleave(function(){
 ...
 $(document).on('click','.delete',function(){
   var id=$(this).attr("id"); 
    // alert(id);
    $("#delete_modal").attr('href',"<?php echo base_url()?>Actualite/delete/"+id);
});

...
<div class='modal fade' id='srcs' tabindex="-1">
  ...
  background-size:10px 10px;}">
          <span id="msg"></span>
         <form id="myform" action="<?= base_url('opportunite/Consultances/ajout') ?>" method="POST" enctype="multipart/form-data" style='text-align: left;'>
            ...
            <div class='modal-dialog'>
                <div class='modal-content'>
                    ...
                    <div class='modal-footer'>
                        <a class='btn btn-danger btn-md' id="delete_modal" href="<?=base_url()?>opportunite/Consultances/delete/<?=$value->ID?>">Supprimer</a>
...
<div class='modal fade' id='modification<?=$value->ID?>' tabindex="-1">
  ...
  background-size:10px 10px;}">
          <span id="msg"></span>
         <form id="myform" action="<?= base_url('opportunite/Consultances/modifier/') ?><?=$value->ID?>" method="POST" enctype="multipart/form-data" style='text-align: left;'>
...
<div class="row">
    <div class="col-md-8" style="text-align: left;"><h1 style="color: rgba(31, 186, 96, 1);">Appels d'offres et Consultances</h1><p></div>
     ...
     <form id="myform" action="<?= base_url('opportunite/Consultances/recherche_emploi') ?>" method="POST" enctype="multipart/form-data">
...
}else echo "<div class='col-md-12' style=' background:  #EBF0EF; min-height: 150px;text-align:left'><h1 style='color:red'>Il n'ya aucun appel d'offre publié</h1></div>";
?> 
</div>
<?php

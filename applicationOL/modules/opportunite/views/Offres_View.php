            ...
            <div class="banner_inner d-flex align-items-center">
                <div class="container">
                    <div class="banner_content">
                        <h2>Publications d'offres d'emplois</h2>
                        <div class="page_link">
                            <a href="<?=base_url();?>">Accueil</a>
                            <a class="" href="#">offres d'emplois</a>
                        </div>
                    </div>
                </div>
            </div>
...
<div class='modal fade' id='srcs' tabindex="-1">
    <div class='modal-dialog modal-lg'>
      <div class='modal-content'>
        <div class='modal-header'>
          ...
          <h3 class="modal-title">Ajout d'une publications d'offre d'emploi</h3>
  ...
  background-size:10px 10px;}">
          <span id="msg"></span>
         <form id="myform" action="<?= base_url('opportunite/Offres/ajout') ?>" method="POST" enctype="multipart/form-data" style='text-align: left;'>
...
<div class="container-fluid row" >
    ...
    <input type="texte" name="date" id="date" class="form-control input-sm" required autocomplete="off" style="display: ;"  required readonly>
            ...
            <div class='modal-dialog'>
                <div class='modal-content'>
                    ...
                    <div class='modal-footer'>
                        <a class='btn btn-danger btn-md' id="delete_modal" href="<?=base_url()?>opportunite/Offres/delete/<?=$value->ID?>">Supprimer</a>
...
<div class='modal fade' id='modification<?=$value->ID?>' tabindex="-1">
  ...
  background-size:10px 10px;}">
          <span id="msg"></span>
         <form id="myform" action="<?= base_url('opportunite/Offres/modifier/') ?><?=$value->ID?>" method="POST" enctype="multipart/form-data" style='text-align: left;'>
...
<?php } ?>
<div class="row">
    <div class="col-md-8" style="text-align: left;"><h1 style="color: rgba(31, 186, 96, 1);">Publications des offres d'emplois</h1><p></div>
        <div class="col-md-4" style="text-align: left;">
     <form id="myform" action="<?= base_url('opportunite/Offres/recherche_emploi') ?>" method="POST" enctype="multipart/form-data">
...
}else echo "<div class='col-md-12' style=' background:  #EBF0EF; min-height: 150px;text-align:left'><h1 style='color:red'>Il n'ya aucune offre d'emploi publiée</h1></div>";
?> 
</div>
<?php

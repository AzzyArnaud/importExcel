...
<html lang="en">
    <head>
        ...
        <title>Recherche consultances</title>
        <?php
    meta_tags();
  ?>
        <!-- Bootstrap CSS -->
            ...
            <div class="banner_inner d-flex align-items-center">
                <div class="container">
                    <div class="banner_content">
                        <h2>Appels d'offres et Consultances</h2>
                        <div class="page_link">
                            <a href="<?=base_url();?>">Accueil</a>
                            <a class="" href="#">Appels d'offres et Consultances</a>
                        </div>
                    </div>
                </div>
            </div>
...
<div class='modal fade' id='srcs' tabindex="-1">
  ...
  background-size:10px 10px;}">
          <span id="msg"></span>
         <form id="myform" action="<?= base_url('opportunite/Consultatnces/ajout') ?>" method="POST" enctype="multipart/form-data" style='text-align: left;'>
            ...
            <div class='modal-dialog'>
                <div class='modal-content'>
                    ...
                    <div class='modal-footer'>
                        <a class='btn btn-danger btn-md' id="delete_modal" href="<?=base_url()?>opportunite/Consultatnces/delete/<?=$value->ID?>">Supprimer</a>
...
<div class='modal fade' id='modification<?=$value->ID?>' tabindex="-1">
  ...
  background-size:10px 10px;}">
          <span id="msg"></span>
         <form id="myform" action="<?= base_url('opportunite/Consultatnces/modifier/') ?><?=$value->ID?>" method="POST" enctype="multipart/form-data" style='text-align: left;'>
...
<?php } ?>
<div class="row">
    <div class="col-md-8" style="text-align: left;"><h1 style="color: rgba(31, 186, 96, 1);">Appels d'offres et Consultances</h1><p></div>
        <div class="col-md-4" style="text-align: left;">
     <form id="myform" action="<?= base_url('opportunite/Consultatnces/recherche_emploi') ?>" method="POST" enctype="multipart/form-data">
...
<div class="col-md-12 admin" id='<?=$value->ID?>' style="margin: 0px 10px 2px 10px;  background:  #EBF0EF;">
    ...
    echo "<div id='gestion' class='row ".$value->ID."' style='display:none'><a href='' data-toggle='modal' data-target='#modification".$value->ID."'><div  class='col-md-6'><i class='lnr lnr-pencil' style='color:#266C67'></i></div></a><div  class='col-md-6'><a href='' id='".$value->ID."' class='delete' data-toggle='modal' data-target='#mydelete".$value->ID."'><i class='lnr lnr-trash' style='color:red'></i></div></a></div>";
        ...
        <div class="col-md-12">Pour plus d'information, clicker ici<br><i class="lnr lnr-paperclip" style="font-size: 30px" ></i>
            <a href="<?=base_url()?>uploads/Consultances/<?=$value->PIECE_JOINTE?>" target='_blank'>
...
}else echo "<div class='col-md-12' style=' background:  #EBF0EF; min-height: 150px;text-align:left'><h1 style='color:red'>Aucun résultat</h1></div>";
?> 
</div>
<?php

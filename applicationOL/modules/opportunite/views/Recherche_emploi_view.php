...
}else echo "<div class='col-md-12' style=' background:  #EBF0EF; min-height: 150px;text-align:left'><h1 style='color:red'>Aucun resultat</h1></div>";
?> 
</div>
<?php

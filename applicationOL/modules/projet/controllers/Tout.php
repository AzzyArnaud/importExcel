...
class Tout extends CI_Controller
{
    ...
    public function index(){
                   ...
                   $rapport=$this->Model->getRequete('SELECT* from projet r left join utilisateur u on r.FAIT_PAR=u.ID  order by r.ID_RAPPORT DESC');
...
if($this->session->userdata('PROFIL')){
        ...
        // $data['option'].='<li><a href='.base_url("zone/Zone_localisation/details/").$localisation["LOCALISATION_ID"].'>Détails</li>'; 
         $data['option'].='<li style="text-align:center"><a href='.base_url("projet/Tout/update/").$val["ID_RAPPORT"].'><span class="lnr lnr-pencil"style="text-alin:center"></li>';
                                        ...
                                        <div class='modal-dialog'>
                                            <div class='modal-content'>
                                                ...
                                                <div class='modal-footer'>
                                                    <a class='btn btn-danger btn-md ' href='" . base_url('projet/Tout/delete/'.$val["ID_RAPPORT"]). "'>Supprimer</a>
    ...
    $datas['breadcrumb'] = $this->make_bread->output();
        ...
        $datas['error'] = "";
            $this->load->view('Tout_View', $datas);
...
if($this->session->userdata('PROFIL')){
    ...
    $this->load->view('Tout_View1',$datas);
  }

...
<div class="container-fluid row" >
  ...
  <div class="col-md-12 form-group">
    ...
    <!-- <center><h2>Rapport des financements</h2></center> -->
     <?= $this->session->flashdata('message') ?>
     <?php if($this->session->userdata('PROFIL')){ ?>
             <form method="post" id='myform' action="<?php echo base_url('rapport/Financement/add')?>"  enctype="multipart/form-data">
                <fieldset class="border p-2"><legend class="w-auto" >Ajout d'un financement</legend>

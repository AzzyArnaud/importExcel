...
<!-- <section class="banner_area">
     ...
     <?php if($this->session->userdata('PROFIL')){ ?>
             <form method="post" id='myform' action="<?php echo base_url('rapport/Devise/add')?>"  enctype="multipart/form-data">
               ...
               <div class="container-fluid row" >
                ...
                <input type="hidden" name="titre" id="titre" class="form-control input-sm" autocomplete="off" value="Cours de change" required>       
                    <!-- </div> -->
                    <div class="col-md-2 sm-12 xs-12 form-group">
            ...
            <?php } ?>
            <h2 style="text-align: center;">Historique de cours de change</h2>

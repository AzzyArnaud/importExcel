...
<!-- <section class="banner_area">
     ...
     <?php if($this->session->userdata('PROFIL')){ ?>
             <form method="post" id='myform' action="<?php echo base_url('rapport/Annuel/modifier/')?><?=$rapport['ID_RAPPORT']?>"  enctype="multipart/form-data">
                <fieldset class="border p-2"><legend class="w-auto" >Ajout d'un Rapport annuel</legend>
               ...
               <div class="container-fluid row" >
                ...
                <input type="file" name="pj" id="pj" class="form-control input-sm"  accept="application/pdf" autocomplete="off" required>     
                    </div>
                </div>

...
<!-- <section class="banner_area">
     ...
     <?php if($this->session->userdata('PROFIL')){ ?>
             <form method="post" id='myform' action="<?php echo base_url('qui_sommes_nous/Membres/update_membre/')?><?=$membre['ID']?>"  enctype="multipart/form-data">
                <fieldset class="border p-2"><legend class="w-auto" >Modification </legend>
               ...
               <div class="container-fluid row" >
                ...
                <input type="text" name="raison" value="<?=$membre['RAISON']?>" id="raison" class="form-control input-sm" autocomplete="off" required>       
                    </div>
                    <div class="col-md-2 sm-12 xs-12 form-group">
                ...
                <input type="number" name="tel" id="tel" value="<?=$membre['TEL']?>" class="form-control input-sm" autocomplete="off" required>       
                    </div>
                    <div class="col-md-2 sm-12 xs-12 form-group">

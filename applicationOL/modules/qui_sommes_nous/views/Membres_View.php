...
<!-- <center>
<span class="lnr lnr-warning" style="font-size:70px;color: red">Interface Encours_View en construction</span>
</center> -->
<!-- <section class="banner_area">
     ...
     <?php if($this->session->userdata('PROFIL')){ ?>
             <form method="post" id='myform' action="<?php echo base_url('qui_sommes_nous/Membres/add')?>"  enctype="multipart/form-data">
               ...
               <div class="container-fluid row" >
                ...
                <input type="text" name="raison" id="raison" class="form-control input-sm" autocomplete="off" required>       
                    </div>
                    <div class="col-md-2 sm-12 xs-12 form-group">
                ...
                <input type="number" name="tel" id="tel" class="form-control input-sm" autocomplete="off" required>       
                    </div>
                    <div class="col-md-2 sm-12 xs-12 form-group">
                        <label>PHOTO:</label>
                    </div>
...
//         dom: 'Bfrtlip',
//         buttons: [
//              {extend: 'print', title: 'LISTE DES MEMBRES <?=date("d-m-Y")?>'},
//                 {extend: 'excel', title: 'LISTE DES MEMBRES DU <?=date("d-m-Y")?>'},
//                 {extend: 'pdf',orientation: 'landscape', title: 'LISTE DES MEMBRES DU <?=date("d-m-Y")?>',exportOptions: {

            ...
            <div class="banner_inner d-flex align-items-center">
                <div class="container">
                    <div class="banner_content">
                        <h2>Crédits aux groupements des jeunes</h2>
                        <div class="page_link">
                            <a href="<?=base_url();?>">Accueil</a>
                            <a class="" href="#">Crédits</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class='modal-dialog  modal-lg'>
      <div class='modal-content'>
        ...
        <div class="modal-body" id="dialog" title="Enregistrement"   style="background-image: linear-gradient(0deg, rgba(255, 255, 255, .05), rgba(150, 150, 150, .05)), linear-gradient(90deg, rgba(255, 255, 255, .05), rgba(150, 150, 150, .05));height:100%;background-size:10px 10px;}">
            <span id="msg"></span>
         <form id="myform" action="<?= base_url('produit_service/Credit/modifier_groupement/') ?>" method="POST" enctype="multipart/form-data">
     ...
     <div class="container" style="margin-bottom:0px; background: white;">
        <p style="margin-top: 110px"></p>
                        <h3 class="text-center" style="margin-top: 110px">
                         <!--  Crédits aux groupements des jeunes  -->
                             <?php
                            ...
                            <a href='<?=base_url()?>produit_service/Credit/vider_groupement' ><span class="lnr lnr-trash" style='color:red'></span></a>
                            <?php
                                }
                            ?>
                        </h3>
...
$('.description').summernote({
  ...
  $.get("<?=base_url()?>produit_service/Credit/modifier_groupement",
  {

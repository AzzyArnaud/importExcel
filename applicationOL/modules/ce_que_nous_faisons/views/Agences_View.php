...
<section class="banner_area">
     ...
     <?php if($this->session->userdata('PROFIL')){ ?>
             <form method="post" id='myform' action="<?php echo base_url('ce_que_nous_faisons/Agences/add')?>"  enctype="multipart/form-data">
               ...
               <div class="container-fluid row" >
                ...
                <input type="text" name="ADRESSE" id="ADRESSE" class="form-control input-sm" autocomplete="off" required>       
                    </div>
                    <div class="col-md-2 sm-12 xs-12 form-group">
...
<script>
       $(document).ready(function(){
        ...
        var profil="<?=$this->session->userdata('PROFIL')?>";
        // alert(profil);
...
//         dom: 'Bfrtlip',
//         buttons: [
//              {extend: 'print', title: 'LISTE DES AGENCES <?=date("d-m-Y")?>'},
//                 {extend: 'excel', title: 'LISTE DES AGENCES DU <?=date("d-m-Y")?>'},
//                 {extend: 'pdf',orientation: 'landscape', title: 'LISTE DES AGENCES DU <?=date("d-m-Y")?>',exportOptions: {

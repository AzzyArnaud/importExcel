...
<html lang="en">
 ...
 <!-- <section class="banner_area">
     ...
     <?php if($this->session->userdata('PROFIL')){ ?>
             <form method="post" id='myform' action="<?php echo base_url('demande_credit/Fiche/modifier/')?><?=$getOne['ID']?>/<?=$type?>"  enctype="multipart/form-data">
                <fieldset class="border p-2"><legend class="w-auto" >Modification d'un fiche de demande de crédit</legend>
               ...
               <div class="container-fluid row" >
                ...
                <input type="text" name="titre" id="titre" class="form-control input-sm" autocomplete="off" required value="<?=$getOne['TITRE']?>">       
                    </div>
                    <div class="col-md-2 sm-12 xs-12 form-group">

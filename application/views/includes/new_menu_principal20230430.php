     ...
     <!--  -->
      ...
      ?>
        ...
        <?php
          ...
          <li class="nav-item <?php if($this->router->class == 'Requisition' || $this->router->class == 'Entree_Stock'|| $this->router->class == 'Rapport_requisition' || $this->router->class == 'Stock' || $this->router->class == 'Sortie_Stock' || $this->router->class == 'Sortie_Stock' || $this->router->class == 'Declassement'|| $this->router->class == 'Stock_general'||$this->router->class == 'Stock_disparu'){ echo 'menu-open';} else{ echo '';}  ?>">

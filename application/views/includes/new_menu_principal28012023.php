    ...
    <div class="sidebar">
      ...
      <nav class="mt-2" style="margin-bottom: 100px">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item <?php if($this->router->class == 'Vente' || $this->router->class == 'Liste_Vente'|| $this->router->class == 'Rapport_vente' || $this->router->class == 'Retour_Vente'| $this->router->class == 'Rapport_vente_par_utilisateur'){ echo 'menu-open';} else{ echo '';}  ?>">
            <a href="#" class="nav-link">

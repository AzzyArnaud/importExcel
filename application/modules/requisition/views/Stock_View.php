    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <tbody>
          ...
          $resultat=$this->Model->getRequete('SELECT saisie_produit.ID_PRODUIT, saisie_produit.NOM_PRODUIT, QUANTITE, PRIX_VENTE, (QUANTITE * PRIX_VENTE) AS PRIX_TOTAL FROM `req_stock` LEFT JOIN saisie_produit ON saisie_produit.ID_PRODUIT = req_stock.ID_PRODUIT WHERE 1');
         $tot = 0;
          foreach ($resultat as $key) 
         {
          ...
          echo "<tr>
                ...
                <td><a class='btn btn-success btn-sm' href='".base_url('requisition/Stock/index_up/'.$key['ID_PRODUIT'].'')."' role='button'> Modifier Prix </a></td>
                ";
         echo '</tr>';
         $tot += $key['PRIX_TOTAL'];

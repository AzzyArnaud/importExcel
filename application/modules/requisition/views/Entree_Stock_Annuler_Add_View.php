    ...
    <section class="content">
      <div class="container-fluid">
          ...
          <div class="col-12">
            ...
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Liste des requisitions mis dans le stock non vendu</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <!-- class="form-inline" -->
        ...
        <tbody>
         ...
         {
          $stock=$this->Model->getRequeteOne('SELECT COUNT(*) AS NUMBER FROM req_barcode WHERE 1 AND ID_REQUISITION = '.$key['ID_REQUISITION'].' AND req_barcode.ID_PRODUIT = '.$key['ID_PRODUIT'].'  AND req_barcode.STATUS != 2');
...
if ($stock['NUMBER'] > 0) {
         ...
         echo '<td>
         <a href="' . base_url('requisition/Entree_Stock/listannuler/'.$key['ID_REQUISITION'].'/'.$key['ID_PRODUIT']) . '" class="btn btn-success btn-sm">Proceder annulation <i class="fa fa-barcode" aria-hidden="true"></i></a>
         </td></tr>';

  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card card-success">
              ...
              <!-- /.card-header -->
              <!-- form start -->
                <form role="form" action="<?=base_url('requisition/Requisition/save_update_req')?>" enctype="multipart/form-data" method="POST">
                  <input type="hidden" name="ID_REQUISITION" value="<?php echo $olddata['ID_REQUISITION']?>">
                <div class="card-body row">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="date" class="form-control" max='<?php echo date('Y-m-d')?>' value="<?php echo $olddata['DATE_REQUISITION']?>" name="DATE_REQUISITION" id="DATE_REQUISITION">
                  <!-- </div> -->
                  ...
                  <select class="form-control select select2-success" data-dropdown-css-class="select2-success" name="ID_FOURNISSEUR" id="ID_FOURNISSEUR" style="width: 100%;">
                    ...
                    foreach ($approv['ID_FOURNISSEUR'] as $key) {
                      if ($olddata['ID_FOURNISSEUR']==$key['ID_FOURNISSEUR']) {
                    ...
                    ?>
                     ...
                     <div class="form-group col-md-2">
                        <label for="POURCENTAGE_R">
                          % Reduction
                          <i class="text-danger"> *</i>
                        </label>
                        <input type="number" name="POURCENTAGE_R" value="<?php echo $olddata['POURCENTAGE_REQUISITION']?>" class="form-control" id="POURCENTAGE_R" step="0.001">
                        <?php echo form_error('POURCENTAGE_R', '<div class="text-danger">', '</div>'); ?>
                     </div>
                    ...
                    foreach ($approv['ID_USER_REQUISITION'] as $key) {
                      if ($olddata['ID_USER_REQUISITION'] == $key['ID_USER']) {
                    ...
                    foreach ($approv['ID_PRODUIT'] as $key) {
                      if ($olddata['ID_PRODUIT'] == $key['ID_PRODUIT']) {
                        echo "<option value=".$key['ID_PRODUIT']." selected>".$key['NOM_PRODUIT']."</option>";
                      }
                      else{
                    ...
                    ?>
                     ...
                     <div class="form-group col-md-2">
                        ...
                        <input type="number" name="PRIX_ACHAT_UNITAIRE" value="<?php echo $olddata['PRIX_ACHAT_UNITAIRE']?>" class="form-control" id="PRIX_ACHAT_UNITAIRE" step="0.001" onkeyup="getpv(this)">
                     ...
                     <div class="form-group col-md-2">
                        ...
                        <input type="number" name="QUANTITE" value="<?php echo $olddata['QUANTITE']?>" class="form-control" id="QUANTITE" step="0.001">
                     ...
                     <div class="form-group col-md-2">
                        ...
                        <input type="date" name="DATE_PERAMPTION"  min='<?php echo date('Y-m-d')?>' value="<?php echo $olddata['DATE_PERAMPTION']?>" class="form-control" id="DATE_PERAMPTION">
                     ...
                     <div class="form-group col-md-3">
                        ...
                        <input type="number" name="PRIX_VENTE_UNITAIRE" value="<?php echo $olddata['PRIX_VENTE_UNITAIRE']?>" class="form-control" onkeyup="getre(this)" id="PRIX_VENTE_UNITAIRE"
                         step="0.001">
...
<script type="text/javascript">
   function getre(){
        ...
        var PRIX_ACHAT_UNITAIRETEMPO =PRIX_VENTE_UNITAIRE/POURCENTAGE;
        var PRIX_ACHAT_UNITAIRE =Math.ceil(PRIX_ACHAT_UNITAIRETEMPO/100)*100;
        // var let x = Math.round(PRIX_VENTE_UNITAIRETEMPO);

        $('#resultat_calcul').html('('+Math.round(PRIX_ACHAT_UNITAIRETEMPO)+')');
        $('#PRIX_ACHAT_UNITAIRE').val(PRIX_ACHAT_UNITAIRE);

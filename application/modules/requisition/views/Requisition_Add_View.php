                  ...
                  <select class="form-control select select2-success" data-dropdown-css-class="select2-success" name="ID_FOURNISSEUR" id="ID_FOURNISSEUR" style="width: 100%;">
                    ...
                    ?>
                     ...
                     <div class="form-group col-md-2">
                        ...
                        <input type="number" name="POURCENTAGE_R" value="0" class="form-control" id="POURCENTAGE_R" step="0.001">
                    ...
                    ?>
                     ...
                     <div class="form-group col-md-1">
                        ...
                        <input type="hidden" name="POURCENTAGE" value="1.4" class="form-control" id="POURCENTAGE" step="0.001">
                     ...
                     <div class="form-group col-md-6">
                        ...
                        <label class="radio-inline">
                          <input type="radio" name="HAVE_FACTURE" id="HAVE_FACTURE1" value="1"> Oui
                        </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <label class="radio-inline">
                          <input type="radio" name="HAVE_FACTURE" id="HAVE_FACTURE0" value="0"> Non
                        </label>
                        <?php echo form_error('HAVE_FACTURE', '<div class="text-danger">', '</div>'); ?>
                    ...
                    ?>
                     ...
                     <div class="form-group col-md-2">
                        ...
                        <input type="number" name="PRIX_ACHAT_UNITAIRE" value="" class="form-control" id="PRIX_ACHAT_UNITAIRE" step="0.001" >
                     ...
                     <div class="form-group col-md-2">
                        <label for="PRIX_VENTE_UNITAIRE">
                          Prix de vente unitaire <span id="resultat_calcul"></span>
                        </label>
                        <!-- <input type="number" name="PRIX_VENTE_UNITAIRE" value="" class="form-control" onkeyup="getre(this)" id="PRIX_VENTE_UNITAIRE"
                         step="0.001"> -->
...
<script type="text/javascript">
   function addElement(){
        ...
        var POURCENTAGE_R=$('#POURCENTAGE_R').val();

        
        var HAVE_FACTURE=$("input[name=HAVE_FACTURE]:checked").val();
        ...
        if (ID_PRODUIT == "") {
          ...
          $.post('<?php echo base_url();?>requisition/Requisition/add_cart_medicament',
                ...
                POURCENTAGE_R:POURCENTAGE_R,
                HAVE_FACTURE:HAVE_FACTURE
                },
                function(data) 
                { 

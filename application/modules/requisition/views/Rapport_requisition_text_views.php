                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-lg-4">
                      ...
                      <select  class="form-control" id="produit" onchange="change(event);">
                        <option value="0">TOUT</option>
                        <option value="1" <?php if($p==1)echo 'selected'; ?>>PRODUITS REQUISITIONES</option>
                        <option value="2" <?php if($p==2)echo 'selected'; ?>>PRODUITS NON REQUISITIONES</option>
                      </select>
                    </div>
...
window.location.replace("<?=base_url()?>requisition/Rapport_requisition_text/index/"+$('#type').val()+"/"+$('#produit').val()+"/"+$('#DATE').val()+"/"+$('#DATE2').val());

<?php 
 ...
 class Requisition extends CI_Controller
 {
     ...
     // $this->cart->destroy();
      ...
      $id=$this->input->post('ID_PRODUIT')."".$this->input->post('PRIX_ACHAT_UNITAIRE')."".$this->input->post('QUANTITE')."".$this->input->post('DATE_PERAMPTION');
          ...
          $data_cart = array(
              ...
              'HAVE_FACTURE'=>$this->input->post('HAVE_FACTURE'),
                    );
  ...
  $html .='<table class="table table-bordered">
      <tr class="text-center"><th colspan="8" class="text-center bg-success">Liste des medicaments de la requisition</th></tr>
        <tr>
        <th>Produit</th>
        <th>PU</th>
        <th>Q</th>
...
$html = null;
  ...
  public function save_requisition()
  {
     ...
     $this->form_validation->set_rules('HAVE_FACTURE', 'Signalement Facture', 'required');
...
$this->cart->destroy();
  ...
  public function delete($ID_REQUISITION)
  {
    ...
    $requisition = array(          
        ...
        'HAVE_FACTURE'=>$olddata['HAVE_FACTURE'],
  ...
  public function save_update_req()
  {
    ...
    $requisition = array(          
        ...
        'ID_FOURNISSEUR'=>$this->input->post('ID_FOURNISSEUR'),
        'DATE_PERAMPTION'=>$this->input->post('DATE_PERAMPTION'),
        'PRIX_VENTE_UNITAIRE'=>$this->input->post('PRIX_VENTE_UNITAIRE'),"ENVOIE"=>0
        );
...
public function update_price(){
  ...
  foreach ($prod as $fab) {
    ...
    $this->Model->update("saisie_produit",array("ID_PRODUIT"=>$fab['ID_PRODUIT']),array("PRIX_PRODUIT"=>$prix['N'],"ENVOIE"=>0));
  }

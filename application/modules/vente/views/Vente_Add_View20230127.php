        ...
        <div class="form-group col-md-12">
          ...
          <div class="row">
            ...
            <div class="form-group col-md-6">
                  ...
                  <select class="form-control " name="ID_TYPE_REMISE_CLIENT" id="ID_TYPE_REMISE_CLIENT" style="width: 100%;"  onchange="getremiseclient()">
                    <option value=""> </option>
                    <?php 
                    ...
                    ?>
                     ...
                     <div class="form-group col-md-12">
                      ...
                      <button type="button" class="btn btn-success btn-block" onclick="submitvente()" >Enregistrer</button>                 
                     </div>
...
<script type="text/javascript">
    ...
    if (ID_TYPE_REMISE_ASS&&!ID_CLIENT) {
     ...
     if (ID_TYPE_REMISE_CLIENT&&!ID_CLIENT) {
      ...
      return;
        ...
        var IS_LIVRAISON=$("input[name=IS_LIVRAISON]").val();
        var IS_DETTE=$("input[name=IS_DETTE]").val();
      // alert('OK');
  ...
  document.getElementById("BARCODE").focus();
                                                      ...
                                                      $("#MONTANT_PAYE").val(0);
                                                      $("#MONTANT_TOTAL").val(0);
                                                      $("input[name=IS_LIVRAISON]").val(0);
                                                      $("input[name=IS_DETTE]").val(0);
                                                      $("#ID_ASSURANCE").val("");
                                                      $("#ID_CLIENT").val("");
            ...
            if (confirm("Voulez-vous vraiment suprimer") == true) {
              $("#load").show();
                 ...
                 $.ajax({
                            ...
                            method:"POST",
                         // async:false,
                            data: {ID_PRODUIT:id1[0],CUNIQUE:id1[1]},

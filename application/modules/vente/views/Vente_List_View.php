            ...
            <div class="card card-success">
              ...
              <div class="card-body">
                ...
                <label for="exampleInputName2">A</label>
                    ...
                    <div class="form-group col-md-6 col-sm-6 col-xs-6">
                    <b>Periode:</b> <b class="text-success"><?php echo $periodes;?></b>
                  </div>
                  <div class="form-group col-md-6 col-sm-6 col-xs-6">
                    <b>Pharmacien(e):</b> <b class="text-success"> <?php echo $vendeurs?></b>
                  </div>
                  <div class="form-group col-md-3 col-sm-3 col-xs-3">
                    <b>Total Vente:</b> <b class="text-success"><?php echo $MONTANT_TOTAL?></b>
                  </div>
                  <div class="form-group col-md-3 col-sm-3 col-xs-3">
                    <b>Total Reduction: </b> <b class="text-success"><?php echo $MONTANT_REMISE?></b>
                  </div>
                  <div class="form-group col-md-3 col-sm-3 col-xs-3">
                    <b>Total Dettes : </b> <b class="text-success"><?php echo $IS_DETTE?></b>
                  </div>
                  <div class="form-group col-md-3 col-sm-3 col-xs-3">
                    <b>Liquidite: </b> <b class="text-success"><?php echo $LIQUIDITE?></b>
                  </div>

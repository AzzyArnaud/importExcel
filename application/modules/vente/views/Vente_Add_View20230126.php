...
<script type="text/javascript">
  function submitvente() {
    ...
    if (ID_ASSURANCE !="") {
      // alert('Not Empty');
      if (ID_CLIENT =="") {
      alert('Veillez chosir un client si vous avez choisi un assurance ');
      $('#ID_CLIENT').focus();
      }
      else{
      // alert('OK');
    ...
    else if (ID_TYPE_REMISE_CLIENT !="") {
      // alert('Not Empty');
      if (ID_CLIENT =="") {
      alert('Veillez chosir un client si vous avez choisi un remise ');
      $('#ID_CLIENT').focus();
      }
      else{
      // alert('OK');
      ...
      // alert('Good to go cause Empty');
      document.getElementById("formvente").submit();
    }

    // if(!$('#ID_ASSURANCE').val().trim()){
    // alert('Champ requis');
    // $('#ID_ASSURANCE').focus();
    // }
    // else{

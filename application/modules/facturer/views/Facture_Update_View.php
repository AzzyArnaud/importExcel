                ...
                <div class="card-body">
                  <div class="row">
                   <div class="form-group col-md-3">
                    ...
                    <input type="date" class="form-control" name="DATE_FACTURE" id="DATE_FACTURE" value="<?=$fact['DATE_FACTURE']?>">
                  ...
                  <select class="form-control select select2-primary" data-dropdown-css-class="select2-primary" name="ID_CLIENT" id="ID_CLIENT" style="width: 100%;">
                    ...
                    <?php
                          foreach ($categ as $key) {
                            ?>
                           <option value='<?=$key['ID_CLIENT']?>' <?php if($fact['ID_CLIENT']==$key['ID_CLIENT'])echo 'selected';?>><?=$key['RAISON']?></option>;
                           <?php
                          }
                          ?>
                  </select>
                     ...
                     <div class="form-group col-md-3">
                        ...
                        <input type="text" name="NUMERO_FACTURE" class="form-control" value="<?=$fact['NUMERO_FACTURE']?>" id="NUMERO_FACTURE">
                  ...
                  <select class="form-control select select2-primary" data-dropdown-css-class="select2-primary" name="AUTO_SEND" id="AUTO_SEND" style="width: 100%;">
                    <option value="0" <?php if ($fact['AUTO_SEND'] == 0) { echo "selected";}?>>NON </option>
                    <option value="1" <?php if ($fact['AUTO_SEND'] == 1) { echo "selected";}?>>OUI </option>
                  ...
                  <option value="2">Service</option>
                    ...
                    <div class="form-group col-md-12">
                     ...
                     <div class="form-group col-md-6">
                        ...
                        <input type="text" name="QUI_SIGNE" class="form-control" id="QUI_SIGNE" step="0.001" value="<?=$fact['QUI_SIGNE']?>">
                     ...
                     <div class="form-group col-md-6">
                        ...
                        <input type="text" name="SON_TITRE" class="form-control" id="SON_TITRE" step="0.001" value="<?=$fact['SON_TITRE']?>">
...
<script>
    ...
    if(i==0) {
      ...
      $.post('<?php echo base_url('facturer/Facture/save_update_facture/'.$fact['ID_FACTURE'])?>',
      {

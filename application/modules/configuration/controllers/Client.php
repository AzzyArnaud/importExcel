...
class Client extends CI_Controller {
   ...
   {
      $TYPE_PERSO=$this->input->post('TYPE_PERSONNE');
...
// $this->form_validation->set_rules('EMAIL_CLIENT', 'EMAIL_CLIENT', 'required');
   ...
   public function reactiver($ID_CLIENT)
    {
      $this->Model->update('saisie_client',array('ID_CLIENT'=>$ID_CLIENT),array('STATUS'=>1,"ENVOIE"=>0));
      $message = "<div class='alert alert-success' id='message'>
    ...
    {
      $this->Model->update('saisie_client',array('ID_CLIENT'=>$ID_CLIENT),array('STATUS'=>0,"ENVOIE"=>0));
      $message = "<div class='alert alert-success' id='message'>

...
class Client extends CI_Controller {
   ...
   public function insert()
   {
      ...
      // $this->Model->create("saisie_client", array('NOM_CLIENT'=>$NOM_CL, 'PRENOM_CLIENT'=>$PRENOM_CL, 'NIF_CLIENT'=>$NIF_CL, 'RC_CLIENT'=>$RC_CL, 'TEL_CLIENT'=>$TEL_CL, 'EMAIL_CLIENT'=>$EMAIL_CL, 'ID_SOCIETE'=>$ID_SOCIETE));

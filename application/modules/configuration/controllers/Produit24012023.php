...
class Produit extends CI_Controller {
  ...
  // $this->form_validation->set_rules('ID_SOCIETE', 'ID_SOCIETE', 'required');
   ...
   public function reactiver($ID_PRODUIT)
    {
      $this->Model->update('saisie_produit',array('ID_PRODUIT'=>$ID_PRODUIT),array('STATUS'=>1));
      $message = "<div class='alert alert-success' id='message'>
    ...
    {
      $this->Model->update('saisie_produit',array('ID_PRODUIT'=>$ID_PRODUIT),array('STATUS'=>0));
      $message = "<div class='alert alert-success' id='message'>

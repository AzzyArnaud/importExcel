...
class Fournisseur extends CI_Controller {
   ...
   public function insert()
   {
      ...
      // $this->Model->create("saisie_fournisseur", array('NOM'=>$NOM, 'ID_SOCIETE'=>$ID_SOCIETE));
  ...
  $this->form_validation->set_rules('ID_SOCIETE', 'ID_SOCIETE', 'required');
   ...
   $NOM=$this->input->post('NOM');
   $ID_SOCIETE=$this->input->post('ID_SOCIETE');
   // $this->Model->update("saisie_fournisseur",array("ID_FOURNISSEUR"=>$ID_FOU),array("NOM"=>$NOM, "ID_SOCIETE"=>$ID_SOCIETE));
   //  redirect(base_url('configuration/Fournisseur'));  

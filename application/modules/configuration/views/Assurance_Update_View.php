              ...
              <form  id="FormData" action="<?php echo base_url()?>configuration/Assurance/update" method="POST" enctype="multipart/form-data">
               <div class="card-body row">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input type="text" name="NIF_ASSURANCE" class="form-control" value="<?php echo $data['NIF_ASSURANCE']?>">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input type="text" name="RC_ASSURANCE" class="form-control" value="<?php echo $data['RC_ASSURANCE']?>">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input type="number" name="TEL_ASSURANCE" class="form-control" value="<?php echo $data['TEL_ASSURANCE']?>">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input type="email" name="EMAIL_ASSURANCE" class="form-control" value="<?php echo $data['EMAIL_ASSURANCE']?>">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input type="text" name="ADRESSE_ASSURANCE" class="form-control" value="<?php echo $data['ADRESSE_ASSURANCE']?>">

  ...
  <div class="container-fluid page-body-wrapper">
    ...
    ?>
     <div class="main-panel">
                ...
                <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                  ...
                  <div>
                    <div class="btn-wrapper">
                      ...
                      <a id="myButton" href="<?= base_url()?>configuration/Avance/Listing" class="btn btn-otline-dark"><i class="icon-printer"></i> List</a>
                      <a id="myButton" href="<?= base_url()?>configuration/Avance" class="btn btn-primary text-white me-0"><i class="icon-download"></i> Import</a>
                    </div>
                  </div>
                </div>
        ...
        <!-- File upload form -->
        <div class="col-md-12">
            <form action="<?php echo base_url()?>configuration/Avance/importFile" method="post" enctype="multipart/form-data">
            <div class="row">

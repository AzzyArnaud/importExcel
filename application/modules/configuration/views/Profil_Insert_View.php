  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card card-success">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form  id="FormData" action="<?php echo base_url()?>configuration/Profil/insert" method="POST" enctype="multipart/form-data">
                <div class="card-body row">
                    <input type="hidden" name="PROFIL_ID" class="form-control" required>

    ...
    <tbody class="tbody">
        <?php
          ...
          foreach($data as $row) {
            ...
            $prix=$this->Model->getOne("req_requisition",array("ID_PRODUIT"=>$row['ID_PRODUIT']));
                           ...
                           <a href='".base_url("configuration/Produit/".$fx."/".$row['ID_PRODUIT'])."' class='btn ".$col."'>".$titr."</a>
                             ...
                             <div class='dropdown '>
                                       ...
                                       <ul class='dropdown-menu dropdown-menu-right'>
                                        <li><a class='dropdown-item' href='".base_url("requisition/Stock/index_up/".$row['ID_PRODUIT'])."'> Modifier Le Prix  </a> </li>

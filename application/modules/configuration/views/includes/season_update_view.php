          ...
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              ...
              <div class="card-header bg-primary">
                <h3 class="card-title text-center text-light">Modification d'un Saison</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form id="FormData" action="<?php echo base_url()?>configuration/Season/update" method="POST" enctype="multipart/form-data">
                <div class="card-body row">
                  <div class="form-group col-lg-6">
                    <label for="YEAR">Annee <spam class="text-danger">*</spam> </label>
                    <input type="text" class="form-control" id="YEAR" name="YEAR" value="<?php echo $data['YEAR']?>">
                    <input type="hidden" class="form-control" id="ID_SAISON" name="ID_USER" value="<?php echo $data['ID_SAISON']?>">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <select name="SEASON_NAME" id="SEASON_NAME" class="form-select">
                     <option value="<?php if($data['ID_SAISON'] == $data['ID_SAISON']) echo $data['ID_SAISON']; ?>" class="text-center"><?php echo $data['SEASON_NAME']?></option>
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input type="namber" class="form-control" id="SART_MONTH" name="SART_MONTH" value="<?php echo $data['SART_MONTH']?>">
                    <?php echo form_error('SART_MONTH', '<div class="text-danger">', '</div>'); ?>
                  </div>
                  <div class="form-group col-lg-6">
                    <label for="END_MONTH">Fin Mois<spam class="text-danger">*</spam> </label>
                    <input type="namber" class="form-control" id="END_MONTH" name="END_MONTH" value="<?php echo $data['END_MONTH']?>">

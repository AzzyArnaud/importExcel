    ...
    <section class="content">
      ...
      <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Miser à Jour Le Stock Endomage</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form  id="FormData" action="<?php echo base_url()?>configuration/Stock_Endomage/update" method="POST" enctype="multipart/form-data">
               <div class="card-body row">
                    <input type="hidden" name="ID_STOCK_ENDOMAGE" class="form-control" value="<?php echo $data['ID_STOCK_ENDOMAGE'];?>">
                  ...
                  <div class="form-group col-lg-6">
                    <label for="exampleInputEmail1">DATE_PERAMPTION:<spam class="text-danger">*</spam></label>
                    <input type="date" name="DATE_PERAMPTION" class="form-control" placeholder="DATE_PERAMPTION" value="<?php echo $data['DATE_PERAMPTION']?>">

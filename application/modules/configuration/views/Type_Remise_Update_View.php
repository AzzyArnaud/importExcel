              ...
              <form  id="FormData" action="<?php echo base_url()?>configuration/Type_Remise/update" method="POST" enctype="multipart/form-data">
               <div class="card-body row">
                   ...
                   <div class="form-group col-lg-6">
                    ...
                    <select class="form-control select select2-success" name="ID_ASSURANCE" class="form-control" value="<?php echo $data['ID_ASSURANCE']?>">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input type="number" name="POURCENTAGE" min="0" max="100" class="form-control" value="<?php echo $data['POURCENTAGE']?>">

    ...
    <section class="content">
      ...
      <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Miser à Jour La Produit</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form  id="FormData" action="<?php echo base_url()?>configuration/Produit/update" method="POST" enctype="multipart/form-data">
               <div class="card-body row">
                    <input type="hidden" name="ID_PRODUIT" class="form-control" value="<?php echo $data['ID_PRODUIT'];?>">
                  <div class="form-group col-lg-6">
                    <label for="exampleInputEmail1">PRODUIT:<spam class="text-danger">*</spam></label>
                    <input type="text" name="NOM_PRODUIT" class="form-control" value="<?php echo $data['NOM_PRODUIT']?>">
                    ...
                    <select class="custom-select" name="ID_CATEGORIE_PRODUIT" class="form-control" value="<?php echo $data['ID_CATEGORIE_PRODUIT']?>">
                     ...
                     <option value="">--- Select ---</option>
                          ...
                          foreach ($categ as $key) {
                            if ($key['ID_CATEGORIE_PRODUIT'] == $data['ID_CATEGORIE_PRODUIT']) {
                              echo"<option value='".$key['ID_CATEGORIE_PRODUIT']."' selected>".$key['NOM']."</option>";
                            }
                            else{
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input type="number" name="PRIX_PRODUIT" class="form-control" value="<?php echo $data['PRIX_PRODUIT']?>">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <label class="radio-inline">
                          <input type="radio" name="AGREE_LOCAL" id="AGREE_LOCAL1" value="1" <?php if ($data['AGREE_LOCAL'] == 1) { echo "checked";}?>> Oui
                        </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <label class="radio-inline">
                          <input type="radio" name="AGREE_LOCAL" id="AGREE_LOCAL0" value="0" <?php if ($data['AGREE_LOCAL'] == 0) { echo "checked";}?>> Non
                        </label>

              ...
              <form  id="FormData" action="<?php echo base_url()?>configuration/Client/update" method="POST" enctype="multipart/form-data">
                <div class="card-body row">
                    ...
                    <div class="form-group col-md-12">
                        <label for="TYPE_PERSONNE">
                          ...
                          <label class="radio-inline">
                            <input type="radio" name="TYPE_PERSONNE" id="inlineRadio1" value="1" <?php if($data['TYPE_PERSONNE']==1) echo "checked";?>> Physique
                          </label>
                          <label class="radio-inline">
                            <input type="radio" name="TYPE_PERSONNE" id="inlineRadio2" value="2" <?php if($data['TYPE_PERSONNE']==2) echo "checked";?>> Morale
                          </label>
                        
                     </div>
                  <div class="form-group col-lg-6">
                    <label for="exampleInputEmail1">CLIENT:<spam class="text-danger">*</spam></label>
                    <input type="text" name="NOM_CLIENT" class="form-control" value="<?php echo $data['NOM_CLIENT']?>">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input type="text" name="PRENOM_CLIENT" class="form-control" value="<?php echo $data['PRENOM_CLIENT']?>">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input type="text" name="NIF_CLIENT" class="form-control" value="<?php echo $data['NIF_CLIENT']?>">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input type="text" name="RC_CLIENT" class="form-control" value="<?php echo $data['RC_CLIENT']?>">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input type="number" name="TEL_CLIENT" class="form-control" value="<?php echo $data['TEL_CLIENT']?>">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input type="text" name="EMAIL_CLIENT" class="form-control" value="<?php echo $data['EMAIL_CLIENT']?>">

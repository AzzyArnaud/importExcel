                ...
                <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                  ...
                  <div>
                    <div class="btn-wrapper">
                      ...
                      <a id="button2" href="<?= base_url()?>configuration/User/Listing" class="btn btn-otline-primary active"><i class="icon-printer"></i> List</a>
          ...
          <div class="row">
            ...
            ?>
                ...
                <div class="card card-success">
                  ...
                  <!-- /.card-header -->
                  <div class="card-body">
                    <table id="customer" class="table table-bordered table-striped table-hover" style="height: 75vh;">
                      <thead>
                      <tr>
                        <th>Nom</th>
                        <th>Username</th>

              ...
              <!-- form start -->
                ...
                <div class="card-body row">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="date" class="form-control" value="<?php echo date('Y-m-d')?>" name="DATE_REQUISITION" id="DATE_REQUISITION">
                  <!-- </div> -->
                  ...
                  <select class="form-control select select2-success" data-dropdown-css-class="select2-success" name="ID_FOURNISSEUR" id="ID_FOURNISSEUR" style="width: 100%;">
                    ...
                    ?>
                     ...
                     <div class="form-group col-md-2">
                        ...
                        <input type="date" name="DATE_PERAMPTION" value="" class="form-control" id="DATE_PERAMPTION">
                     ...
                     <div class="form-group col-md-2">
                        ...
                        <input type="number" name="PRIX_VENTE_UNITAIRE" value="" class="form-control" id="PRIX_VENTE_UNITAIRE" placeholder="Prix de vente" step="0.001">
...
<script type="text/javascript">
   function addElement(){
        ...
        // alert(ID_PRODUIT);
        // alert(PRIX_ACHAT_UNITAIRE);
        // alert(QUANTITE);
        // alert(DATE_PERAMPTION);
        // alert(PRIX_VENTE_UNITAIRE);

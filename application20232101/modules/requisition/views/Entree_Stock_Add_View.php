...
if ($reste > 0) {
         ...
         echo '<td>
         <a href="' . base_url('requisition/Entree_Stock/scan/'.$key['ID_REQUISITION'].'/'.$key['ID_PRODUIT']) . '" class="btn btn-success">Proceder au scan <i class="fa fa-barcode" aria-hidden="true"></i></a>
         </td></tr>';

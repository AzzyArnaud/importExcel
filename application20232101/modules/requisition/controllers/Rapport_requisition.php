<?php 
 ...
 class Rapport_requisition extends CI_Controller
 {
  ...
  public function index($date=''){
    ...
    $query=$this->Model->getRequete("SELECT* from saisie_produit pro where ID_PRODUIT in(SELECT ID_PRODUIT FROM req_requisition WHERE 1 ".$condition.") AND ID_SOCIETE=".$this->session->userdata('STRAPH_ID_SOCIETE')." order by NOM_PRODUIT ");

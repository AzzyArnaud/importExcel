    ...
    <section class="content">
      ...
      <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Miser à Jour Le Droit</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form  id="FormData" action="<?php echo base_url()?>configuration/Droits/update" method="POST" enctype="multipart/form-data">
               <div class="card-body row">
                    <input type="hidden" name="ID_DROIT" class="form-control" value="<?php echo $data['ID_DROIT'];?>" required>
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input type="number" name="ID_SOCIETE" class="form-control" placeholder="ID_SOCIETE" value="<?php echo $data['ID_SOCIETE']?>">

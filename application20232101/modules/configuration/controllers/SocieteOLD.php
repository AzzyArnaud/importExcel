...
class Societe extends CI_Controller {
 ...
 $this->form_validation->set_rules('SOCIETE', 'SOCIETE', 'required');
   ...
   public function reactiver($ID_SOCIETE)
    {
      $this->Model->update('config_societe',array('ID_SOCIETE'=>$ID_SOCIETE),array('STATUS'=>1));
      $message = "<div class='alert alert-success' id='message'>
    ...
    {
      $this->Model->update('config_societe',array('ID_SOCIETE'=>$ID_SOCIETE),array('STATUS'=>0));
      $message = "<div class='alert alert-success' id='message'>

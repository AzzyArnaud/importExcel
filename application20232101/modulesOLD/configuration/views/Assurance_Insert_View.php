              ...
              <form  id="FormData" action="<?php echo base_url()?>configuration/Assurance/insert" method="POST" enctype="multipart/form-data">
                <div class="card-body row">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input type="text" name="NOM_ASSURANCE" class="form-control" placeholder="NOM_ASSURANCE" value="<?=set_value('NOM_ASSURANCE')?>">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input type="text" name="NIF_ASSURANCE" class="form-control" placeholder="NIF_ASSURANCE" value="<?=set_value('NIF_ASSURANCE')?>">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input type="text" name="RC_ASSURANCE" class="form-control" placeholder="RC_ASSURANCE" value="<?=set_value('RC_ASSURANCE')?>">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input type="number" name="TEL_ASSURANCE" class="form-control" placeholder="TEL_ASSURANCE" value="<?=set_value('TEL_ASSURANCE')?>">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input type="email" name="EMAIL_ASSURANCE" class="form-control" placeholder="EMAIL_ASSURANCE" value="<?=set_value('EMAIL_ASSURANCE')?>">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input type="text" name="ADRESSE_ASSURANCE" class="form-control" placeholder="ADRESSE_ASSURANCE" value="<?=set_value('ADRESSE_ASSURANCE')?>">

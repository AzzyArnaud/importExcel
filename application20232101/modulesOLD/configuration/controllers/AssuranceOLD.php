...
class Assurance extends CI_Controller {
   ...
   public function insert()
   {
      ...
      // $this->Model->create("saisie_assurance", array('NOM_ASSURANCE'=>$NOM_ASS, 'NIF_ASSURANCE'=>$NIF_ASS, 'RC_ASSURANCE'=>$RC_ASS, 'TEL_ASSURANCE'=>$TEL_ASS, 'EMAIL_ASSURANCE'=>$EMAIL_ASS, 'ADRESSE_ASSURANCE'=>$ADRESSE_ASS, 'ID_SOCIETE'=>$ID_SOCIETE));
...
$this->form_validation->set_rules('ID_SOCIETE', 'ID_SOCIETE', 'required');
   ...
   public function reactiver($ID_ASSURANCE)
    {
      $this->Model->update('saisie_assurance',array('ID_ASSURANCE'=>$ID_ASSURANCE),array('STATUS'=>1));
      $message = "<div class='alert alert-success' id='message'>
    ...
    {
      $this->Model->update('saisie_assurance',array('ID_ASSURANCE'=>$ID_ASSURANCE),array('STATUS'=>0));
      $message = "<div class='alert alert-success' id='message'>

...
<head>
  ...
  <link rel="icon" type="image/x-icon" href="<?php echo base_url() ?>dist/straphael_favicon.png">
  ...
  <link rel="stylesheet" href="<?php echo base_url() ?>dist/css/print.css">
                     <!-- Hichart -->
<script src="<?php echo base_url() ?>higthchart/code/highcharts.js"></script>
<script src="<?php echo base_url() ?>higthchart/code/modules/sunburst.js"></script>
<script src="<?php echo base_url() ?>higthchart/code/modules/exporting.js"></script>
<script src="<?php echo base_url() ?>higthchart/code/modules/xrange.js"></script>
<script src="<?php echo base_url() ?>higthchart/code/modules/export-data.js"></script>
<script src="<?php echo base_url() ?>higthchart/code/highcharts-3d.js"></script> 
</head>

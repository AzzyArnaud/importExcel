        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item <?php if($this->router->class == 'Profil_Droit' || $this->router->class == 'User'){ echo 'menu-open';} else{ echo '';}  ?>">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?=base_url('configuration/Assurance')?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Assurances</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="<?=base_url('configuration/Client')?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Clients</p>
                </a>
              </li>
          ...
          <li class="nav-item <?php if($this->router->class == 'Vente' || $this->router->class == 'Entree_Stocks'){ echo 'menu-open';} else{ echo '';}  ?>">
            <a href="#" class="nav-link">

    ...
    <div class="sidebar">
      ...
      <nav class="mt-2" style="margin-bottom: 100px">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item <?php if($this->router->class == 'Requisition' || $this->router->class == 'Entree_Stock'|| $this->router->class == 'Rapport_requisition' || $this->router->class == 'Stock' ){ echo 'menu-open';} else{ echo '';}  ?>">

            <a href="#" class="nav-link <?php if($this->router->class == 'Requisition' || $this->router->class == 'Entree_Stock' || $this->router->class == 'Stock' || $this->router->class == 'Rapport_requisition' ){ echo 'active';} else{ echo '';}  ?>">
